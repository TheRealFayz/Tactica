...
Tactica.DefaultData = {
    ...
    ["Onyxia's Lair"] = {
        ["Onyxia"] = {
            ["Default"] = "Tanks: In phase 1, tank the boss where she is now, turned 180 degrees to fase the wall. In Phase 2 she will lift off into the air, and you will tank small welps coming from the pits on the left and right sides of the room. In Phase 3 when she lands again, tank her in the same location as phase 1. Keep her turn away from raid at all times.\nMDPS: Never stand behind or infront of Onyxia. Focus adds when up. ***DO NOT PULL THREAT OF YOU WILL KILL EVERYONE!***. Do not DPS Onyxia when she lands. Allow the tank to pick her up and reposition her before staring DPS again. Kill remaining adds while the tank positions her.\nRDPS: Never stand behind or infront of Onyxia. ***DO NOT PULL THREAT OF YOU WILL KILL EVERYONE!***. During phase 2 you will need to continue DPS on Onyxia until she lands at 40% health. ***STOP ALL DPS ON ONYXIA WHEN SHE LANDS!*** Allow the tank to pick her up and reposition her before staring DPS again.\nHealers: Focus on tank first, and the rest of the raid second.\nClass Specific: Fear Ward (Priests) and Tremor Totem (Shaman) prio for MT during phase 3.\nBoss Ability: During phase 2 Onyxia will occasionally Fire Breath the center of the room. This will kill anyone in it's path. To avoid it look where Onyxia currently is facing and stand at the edge of the room on the left or right of her. Note the boss will move about the room in Phase 2."
        }
    }
}
